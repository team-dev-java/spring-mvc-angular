    	...
    	<div class="page-content page-content-popup">
			...
			<div class="page-fixed-main-content">
		    	...
		    	<div class="alert alert-block alert-danger fade in">
					...
					<p>
						Pleae note that the new <b>Admin 6</b> theme includes only 3 base templates(start.html, index.html and index-boxed.html) which are fully compatible with Metronic's base admin themes(admin 1, admin 1, admin 3, admin 4, admin 5) features and templates and into these 3 base templates you can include any template or component from the base admin themes. So just consider Admin 6 as a new layout compatible with the entire Metronic framework. 
					</p>
					<p> 
						The reason is to avoid maintenance complication with including and repeating the demo pages in all upcoming admin themes. 
					For any further questions please contact the <a href="http://keenthemes.com/forums/forum/support/metronic/" target="_blank">Metronic Support</a>.
					</p>
				</div>
				<!-- END ALERT -->
